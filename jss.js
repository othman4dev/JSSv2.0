...
if ( compare( getComputedStyle(document.querySelector('#div')).getPropertyValue('width') , '>',  '50' )) {
 ...
 var observerw7j5xb5ad = new MutationObserver(function(mutations) {
...
var configw7j5xb5ad = { attributes: true, attributeFilter: ['style'] };
observerw7j5xb5ad.observe(document.querySelector('#div2 '), configw7j5xb5ad);

 var observermxnjcpi3d = new MutationObserver(function(mutations) {
	mutations.forEach(function(mutation) {
		if (mutation.attributeName === 'style') {
...
var configmxnjcpi3d = { attributes: true, attributeFilter: ['style'] };
observermxnjcpi3d.observe(document.querySelector('#div2 '), configmxnjcpi3d);
